# -*- coding: utf-8 -*-
"""
Created on Tue Jul 26 17:48:50 2022
...
if __name__ == '__main__':
    ...
    # train_cells = temp_cells
    
    temp_cells = []
    for cell in val_cells:
        if label[cell] <= 1000:
            temp_cells.append(cell)
    val_cells = temp_cells
    
    temp_cells = []
    for cell in test_cells:
        if label[cell] <= 1000:
            temp_cells.append(cell)
    test_cells = temp_cells
    ...
    #6. 结果存储
    #########################################################################    
    np.save('../data/CNN_short_pred_valid',valid_pred)
    np.save('../data/CNN_short_pred_test',test_pred)