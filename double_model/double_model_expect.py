# -*- coding: utf-8 -*-
"""
Created on Fri Jul 29 18:23:47 2022
...
## 这里并不是作弊，只是将short_life_model_CNN的结果放在这里，计算总数据集的误差
...
print('———————————————————————————————————————————————')
print('结合长短寿命模型的总评价（Elastic Net + CNN）：')
# 若使用CNN_short的结果
